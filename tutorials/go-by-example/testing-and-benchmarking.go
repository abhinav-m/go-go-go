...
// Test is created by writing a function
// with the name beginning with "Test"
...
// Run all benchmarks in the current project. All tests are run prior to benchmarks.
